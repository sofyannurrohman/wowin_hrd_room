    ...
    <aside class="w-64 flex flex-col bg-[#253f86] text-white overflow-hidden shadow-xl z-10">
      ...
      <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-8 scrollbar-hide">
        ...
        <div class="space-y-2">
          ...
          <a
            href="#"
            class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg text-blue-100 hover:bg-white/10 hover:text-white transition-colors group"
          >
             <BarChart2Icon class="w-5 h-5 opacity-80 group-hover:opacity-100" />
             Results & Analytics
          </a>
        </div>
